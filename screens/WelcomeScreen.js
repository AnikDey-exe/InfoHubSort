...
export default class WelcomeScreen extends React.Component {
  ...
  userSignUp = (emailID,password,confirmPassword) => {
    if(password !== confirmPassword) {
        ...
        return Alert.alert("Please enter your first name.");
    }
    else if(this.state.lastName === ''){
        return Alert.alert("Please enter your last name.");
    }
    ...
    return (
      <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
          ...
          <View>
            ...
            style={{width: 500, height: 500, alignItems: 'center',marginTop: 0}}/>
            
          </View>
          <Text style={styles.title}> Info Brain </Text>
          <Card containerStyle={{position: 'absolute', bottom: 150, borderRadius: 10}}>
